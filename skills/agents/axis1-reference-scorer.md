...
model: sonnet
purpose: 축 1 — 레퍼런스 충실도 (Coverage·Accuracy·Authority·Balance)
---
...
3. `papers/analyzed/{stage}/*.md` (stage = research-gap | flow) — authority·balance 검증용. 직접 Read.
...
4. `papers/analyzed/{stage}/*.md` (stage = research-gap | flow)
